	...
	<div class="container">
		...
		<p>Check the below symptoms you have</p>
			...
			<div class="row">
				...
				<div class="col col-lg-3">
					<div class="checkbox">
						<label><input type="checkbox" name="diabities"
							value="Y">Diabetes</label>
						</div>
							<div class="checkbox">
							...
							<div class="checkbox">
								<label><input type="checkbox" name="kidneydisease" value="Y">Kidney Disease</label>
							</div>
							<div class="checkbox">
								<label><input type="checkbox" name="overweight" value="Y">Sever Over Weight</label>
							</div>
				</div>
			</div>
